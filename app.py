...
<style>
    ...
    .stApp {
        background: linear-gradient(-45deg, #0f172a, #1e1b4b, #311042, #0d0e15);
    ...
    .header-banner {
        background: linear-gradient(135deg, rgba(79, 70, 229, 0.15) 0%, rgba(217, 70, 239, 0.1) 50%, rgba(13, 14, 21, 0.4) 100%);
